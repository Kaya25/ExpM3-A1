...
R2 values were calculated on models with different combinations of the variables to select the best model. The model that explained the variance the best was the one with diagnosis, verbal IQ, types_CHI (unique words), and tokens_CHI (overall amount of words) as fixed effects, and by-subject random slopes and intercepts for visits as random effects. The fixed effects explained 73.75%, while the full model accounted for 85.81% of the variance.
